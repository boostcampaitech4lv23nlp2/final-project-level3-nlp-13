...
class FlaxDataCollatorForBartDenoisingLM:
    ...
    def permute_sentences(self, input_ids):
        ...
        num_to_permute_map = {sent_idx: count for sent_idx, count in zip(example_has_multiple_sentences, num_to_permute)}
    ...
    for epoch in epochs:
        ...
        for step, batch_idx in enumerate(tqdm(train_batch_idx, desc="Training...", position=1)):
            ...
            if cur_step % training_args.logging_steps == 0 and cur_step > 0:
                ...
                epochs.write(f"Step... ({cur_step} | Loss: {train_metric['loss']}, Learning Rate:" f" {train_metric['learning_rate']})")
